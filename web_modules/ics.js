...
var setGeolocation_1 = createCommonjsModule(function (module, exports) {
...
var setContact_1 = createCommonjsModule(function (module, exports) {
...
var setOrganizer_1 = createCommonjsModule(function (module, exports) {
...
var foldLine_1 = createCommonjsModule(function (module, exports) {
...
var setAlarm_1 = createCommonjsModule(function (module, exports) {
...
var _formatDate = _interopRequireDefault(formatDate_1);

var _foldLine = _interopRequireDefault(foldLine_1);
...
var formatText_1 = createCommonjsModule(function (module, exports) {
...
var setDescription_1 = createCommonjsModule(function (module, exports) {
...
var _formatText = _interopRequireDefault(formatText_1);
...
var setSummary_1 = createCommonjsModule(function (module, exports) {
...
var setLocation_1 = createCommonjsModule(function (module, exports) {
...
var _setGeolocation = _interopRequireDefault(setGeolocation_1);

var _setContact = _interopRequireDefault(setContact_1);

var _setOrganizer = _interopRequireDefault(setOrganizer_1);

var _setAlarm = _interopRequireDefault(setAlarm_1);

var _setDescription = _interopRequireDefault(setDescription_1);

var _setSummary = _interopRequireDefault(setSummary_1);

var _formatDuration = _interopRequireDefault(formatDuration_1);

var _foldLine = _interopRequireDefault(foldLine_1);

var _setLocation = _interopRequireDefault(setLocation_1);
...
var defaults = {
  ...
  method: 'PUBLISH',
  uid: (0, _v["default"])(),
  timestamp: (0, utils.formatDate)(null, 'utc'),
  start: (0, utils.formatDate)(null, 'utc')
};
...
function formatEvent() {
  ...
  icsFormat += (0, utils.foldLine)("PRODID:".concat(productId)) + '\r\n';
  icsFormat += (0, utils.foldLine)("METHOD:".concat(method)) + '\r\n';
  icsFormat += calName ? (0, utils.foldLine)("X-WR-CALNAME:".concat(calName)) + '\r\n' : '';
  icsFormat += "X-PUBLISHED-TTL:PT1H\r\n";
  icsFormat += 'BEGIN:VEVENT\r\n';
  icsFormat += "UID:".concat(uid, "\r\n");
  icsFormat += (0, utils.foldLine)("SUMMARY:".concat(title ? (0, utils.setSummary)(title) : title)) + '\r\n';
  icsFormat += "DTSTAMP:".concat(timestamp, "\r\n"); // All day events like anniversaries must be specified as VALUE type DATE

  icsFormat += "DTSTART".concat(start && start.length == 3 ? ";VALUE=DATE" : "", ":").concat((0, utils.formatDate)(start, startOutputType || startType, startInputType), "\r\n"); // End is not required for all day events on single days (like anniversaries)

  if (!end || end.length !== 3 || start.length !== end.length || start.some(function (val, i) {
    return val !== end[i];
  })) {
    if (end) {
      icsFormat += "DTEND".concat(end.length === 3 ? ";VALUE=DATE" : "", ":").concat((0, utils.formatDate)(end, endOutputType || startOutputType || startType, endInputType || startInputType), "\r\n");
    }
  }

  icsFormat += sequence ? "SEQUENCE:".concat(sequence, "\r\n") : '';
  icsFormat += description ? (0, utils.foldLine)("DESCRIPTION:".concat((0, utils.setDescription)(description))) + '\r\n' : '';
  icsFormat += url ? (0, utils.foldLine)("URL:".concat(url)) + '\r\n' : '';
  icsFormat += geo ? (0, utils.foldLine)("GEO:".concat((0, utils.setGeolocation)(geo))) + '\r\n' : '';
  icsFormat += location ? (0, utils.foldLine)("LOCATION:".concat((0, utils.setLocation)(location))) + '\r\n' : '';
  icsFormat += status ? (0, utils.foldLine)("STATUS:".concat(status)) + '\r\n' : '';
  icsFormat += categories ? (0, utils.foldLine)("CATEGORIES:".concat(categories)) + '\r\n' : '';
  icsFormat += organizer ? (0, utils.foldLine)("ORGANIZER;".concat((0, utils.setOrganizer)(organizer))) + '\r\n' : '';
  icsFormat += busyStatus ? (0, utils.foldLine)("X-MICROSOFT-CDO-BUSYSTATUS:".concat(busyStatus)) + '\r\n' : '';
  icsFormat += created ? 'CREATED:' + (0, utils.formatDate)(created) + '\r\n' : '';
  icsFormat += lastModified ? 'LAST-MODIFIED:' + (0, utils.formatDate)(lastModified) + '\r\n' : '';

  if (attendees) {
    attendees.map(function (attendee) {
      icsFormat += (0, utils.foldLine)("ATTENDEE;".concat((0, utils.setContact)(attendee))) + '\r\n';
    });
  }

  if (alarms) {
    alarms.map(function (alarm) {
      icsFormat += (0, utils.setAlarm)(alarm);
    });
  }

  icsFormat += recurrenceRule ? "RRULE:".concat(recurrenceRule, "\r\n") : '';
  icsFormat += duration ? "DURATION:".concat((0, utils.formatDuration)(duration), "\r\n") : '';
...
var _joi = _interopRequireDefault(joiBrowser_min);
...
var _schema = _interopRequireDefault(schema_1);
...
var pipeline = createCommonjsModule(function (module, exports) {
...
var _validate = _interopRequireDefault(validate);
...
var _v = _interopRequireDefault(v4_1);
...
function validateAndBuildEvent(event) {
  return (0, pipeline.validateEvent)((0, pipeline.buildEvent)(event));
}
...
function applyInitialFormatting(_ref) {
  ...
  return {
    error: null,
    value: (0, pipeline.formatEvent)(value)
  };
}
...
function createEvent(attributes, cb) {
  ...
  if (!cb) {
    ...
    try {
      event = (0, pipeline.formatEvent)(_value);
    } catch (error) {
      return {
        error: error,
        value: null
  ...
  return cb(null, (0, pipeline.formatEvent)(value));
}
